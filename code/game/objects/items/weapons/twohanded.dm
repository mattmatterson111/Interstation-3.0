...
//I rewrote TwoHanded stuff again. Now any weapon can be twohanded by using the UI button. - Matt
...
/obj/item/weapon/proc/update_unwield_icon()//That way it doesn't interupt any other special item_states.
	if((wielded) && wielded_icon)
...
/obj/item/weapon/twohanded/offhand/unwield()
	//if(wielded)//Only delete if we're wielded. //This line breaks things - Matt
	wielded = FALSE
	qdel(src)
